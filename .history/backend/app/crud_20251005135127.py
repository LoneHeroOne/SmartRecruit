...
def list_all_applications(db: Session) -> Sequence[models.Application]:
    stmt = select(models.Application, models.User, models.Job).join(models.User).join(models.Job).order_by(models.Application.applied_at.desc())
    return db.execute(stmt).all()

def update_application_status(db: Session, *, application: models.Application, status: str) -> models.Application:
